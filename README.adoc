...
Contains minimal example java project for link:workflows#upload_release_github_attachmentyaml[upload_release_github_attachment.yaml] that builds java, packages it to rpm and attaches the result rpm to the release
