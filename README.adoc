...
Contains minimal example java project for upload_release_github_attachment.yaml that builds java, packages it to rpm and attaches the result rpm to the release
