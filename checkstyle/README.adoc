...
Documentation and further configuration for each check can be found link:https://checkstyle.org/checks.html[in their documentation]. See <<Supported versions>> for compatibility information.
...
See link:https://mvnrepository.com/artifact/com.puppycrawl.tools/checkstyle/versions[Checkstyle Maven Central versions] or link:https://github.com/checkstyle/checkstyle/releases[Checkstyle GitHub releases] for more information about new releases.

Support matrix for different Java versions can be found on link:https://checkstyle.sourceforge.io/#JRE_and_JDK[Checkstyle homepage].
