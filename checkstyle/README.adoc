...
Documentation and further configuration for each check can be found link:https://checkstyle.org/checks.html[in their documentation]. See <<Supported versions>> for more information about compatibility between Checkstyle and different Java versions.
...
See link:https://mvnrepository.com/artifact/com.puppycrawl.tools/checkstyle/versions[Maven Central] or link:https://github.com/checkstyle/checkstyle/releases[Checkstyle GitHub] for new Checkstyle releases and link:https://checkstyle.sourceforge.io/#JRE_and_JDK[Checkstyle homepage] for more information about supported Java versions.
