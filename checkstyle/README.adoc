...
Documentation and further configuration for each check can be found https://checkstyle.org/checks.html[in their documentation]. See <<Supported versions>> for information.
