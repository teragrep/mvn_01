...
The goal of this project is to be a minimal example demo for link:../workflows#upload_release_github_attachmentyaml[upload_release_github_attachment.yaml]. The `rpm/rpm.pom.xml` contains examples on how to include the built java artifact and auxiliary files from `rpm/aux/` to different locations with different permissions.
