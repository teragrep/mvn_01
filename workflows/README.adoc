...
Will attach the wanted artifacts to the GitHub release. The example will first build a jar, then builds and signs the rpm that is then attached as an artifact to the release. Example project can be found in link:../rpm-packaging[rpm-packaging] directory.
